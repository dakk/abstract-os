...
/** Enable paging */
int 
arch_paging_enable(uint32_t *page_dir)
{
	unsigned int cr0;
 ...
 */
uint32_t 
cpu_exec(uint32_t cpu, void *code)
{
	return 0;
}
