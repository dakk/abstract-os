...
contents_arch = [ ["ARCH_X86", "-Wall -I.. -I. -Iinclude -Iinclude/klibc/cxx -Wno-write-strings -nostdlib -nostartfiles -ffreestanding -fno-stack-protector -nostdlib -nostdinc -fno-builtin -nodefaultlibs -fno-exceptions", "-Tarch/x86/link.ld", "-felf", "arch/x86/syscall.o arch/x86/cpu.o arch/x86/boot.o arch/x86/dt.o arch/x86/clock.o arch/x86/timer.o arch/x86/io.o arch/x86/arch.o arch/x86/kvideo.o arch/x86/kkeyb.o arch/x86/calls.o", "arch/x86/kernel", "gcc", "as", "ld", "nasm", ["BIT32", "ARCH \"x86\"", "X86"]], ["ARCH_LINUX32_HOSTED", "-Wall -I.. -I. -Iinclude -Iinclude/klibc/cxx -nostdlib", "", "", "arch/linux32_hosted/arch.o", "arch/linux32_hosted/kernel", "gcc", "as", "ld", "nasm", ["BIT32", "ARCH \"linux32_hosted\"", "LINUX32_HOSTED"]] ]
...
contents =  [ 	
				...
				["TEST", ["TEST"], "Test.o", []],
				["PAGING", ["PAGING"], "mm/paging.o", []],
				["SECURITY", ["SECURITY"], "security/SecurityManager.o", []],
				["MEDIA", ["MEDIA"], "media/MediaManager.o", []],
				["PRINT", ["PRINT"], "print/PrintManager.o", []],
				["UI", ["UI"], "ui/UiManager.o ui/Window.o ui/Rendering.o ui/widgets/Widget.o ui/widgets/Box.o ui/widgets/Label.o ui/widgets/Button.o ui/widgets/ProgressBar.o", []],
				["SHELL", ["SHELL"], "Shell.o", []]
			]
