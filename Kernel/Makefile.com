KLIBC = klibc/malloc.o klibc/stdio.o klibc/string.o \
        klibc/time.o klibc/typeconv.o
KLIBCPP = klibc/cxx/iostream.o
MEM	  = mm/phys.o mm/mm.o
COM_O = arch/arch.o Main.o Driver.o Term.o Device.o ArchManager.o DeviceManager.o DriverManager.o Task.o TaskManager.o $(KLIBC) $(KLIBCPP) $(MEM)
